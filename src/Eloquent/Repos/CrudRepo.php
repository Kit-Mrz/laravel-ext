...
use MrzKit\LaravelExt\Eloquent\Contract\CrudRepoContract;
use MrzKit\LaravelExt\Eloquent\Contract\ModelContract;

abstract class CrudRepo implements ModelContract, CrudRepoContract
{
    /**
     * @var Model 模型
     */
     ...
     * @return bool
     */
    public function stores(array $storeData)
    {
        $model = $this->getModel();
